...
-  **Hospital Locator**: Automatically detects user location and searches over OpenStreetMap & curated databases to locate nearby specialized cancer clinics and general hospitals, computing actual distances with interactive map displays.

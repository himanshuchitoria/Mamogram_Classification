...
### **Frontend (`/frontend`)**n+Modern SPA built with **React** and **Vite**, utilizing responsive, minimal generic styling (`App.css`). No extra component frameworks dependencies.
